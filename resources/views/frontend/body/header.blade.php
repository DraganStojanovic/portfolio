                        ...
                        <nav class="menu__nav">
                            <div class="logo">
                                <a href="index.html" class="logo__black"><img
                                        src="{{ asset('frontend/assets/img/logo/starwars.png') }}" alt=""></a>
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="nav-item {{ Request::path() ==  '/' ? 'active' : '' }}"><a
                                            href="{{ url('/') }}">Home</a></li>
                                    <li class="nav-item {{ Request::path() ==  'about' ? 'active' : '' }}"><a
                                    ...
                                    <li class="{{ ($route == 'home.blog') ? 'active' : '' }}"><a
                                            href="{{ route('home.blog') }}">My Blog</a>
