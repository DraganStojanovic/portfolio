                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="short_description" class="form-control" type="text" value="{{ $aboutpage->short_description }}" id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <textarea id="elm1" name="long_description" aria-hidden="true">
